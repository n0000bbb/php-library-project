...
<head>
<meta charset="UTF-8">
<title>การยืม - Library of Sakolraj   </title>
...
<nav class="col-md-2 bg-dark sidebar text-white p-3">
            ...
            <ul class="nav nav-pills flex-column gap-1">
                ...
                <li class="nav-item">
                    <a href="borrowing.php" class="nav-link text-white active">การยืม</a>
                </li>
            </ul>
...
<main class="col-md-10 bg-light p-4">
    <h3>การยืม</h3>
    <p class="text-muted">การยืม–คืนหนังสือ</p>
    <a href="addBorrowing.php" class="btn btn-success mb-3">+ เพิ่มการยืม</a>
